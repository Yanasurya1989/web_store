...
<head>
  ...
  <!-- Template CSS -->
  <link rel="stylesheet" href="{{asset('Sprystore-Starter')}}/assets/css/style-starter.css">
  <!-- Template CSS -->
		...
		<div class="container py-lg-5">
			...
			<div class="welcome-grids row mt-5">
				<div class="col-lg-2 col-md-4 col-6 welcome-image">
						<div class="boxhny13">
								<a href="#URL">
										<img src="{{asset('Sprystore-Starter')}}/assets/images/grid1.jpg" class="img-fluid" alt="" />
				...
				<div class="col-lg-2 col-md-4 col-6 welcome-image">
						<div class="boxhny13">
								<a href="#URL">
										<img src="{{asset('Sprystore-Starter')}}/assets/images/grid3.jpg" class="img-fluid" alt="" />
								<div class="boxhny-content">
				...
				<div class="col-lg-2 col-md-4 col-6 welcome-image">
						<div class="boxhny13">
								<a href="#URL">
										<img src="{{asset('Sprystore-Starter')}}/assets/images/grid2.jpg" class="img-fluid" alt="" />
								<div class="boxhny-content">
									<h3 class="title">Product</h3>
								</div>
							</a>
				...
				<div class="col-lg-2 col-md-4 col-6 welcome-image">
						<div class="boxhny13">
								<a href="#URL">
										<img src="{{asset('Sprystore-Starter')}}/assets/images/grid4.jpg" class="img-fluid" alt="" />
								<div class="boxhny-content">
									<h3 class="title">Product</h3>
								</div>
							</a>
				...
				<div class="col-lg-2 col-md-4 col-6 welcome-image">
						<div class="boxhny13">
								<a href="#URL">
										<img src="{{asset('Sprystore-Starter')}}/assets/images/grid5.jpg" class="img-fluid" alt="" />
								<div class="boxhny-content">
									<h3 class="title">Product</h3>
								</div>
							</a>
				...
				<div class="col-lg-2 col-md-4 col-6 welcome-image">
						<div class="boxhny13">
								<a href="#URL">
										<img src="{{asset('Sprystore-Starter')}}/assets/images/grid6.jpg" class="img-fluid" alt="" />
								<div class="boxhny-content">
									<h3 class="title">Product</h3>
								</div>
							</a>
			 ...
			 <div class="container py-lg-5">
					<div class="align-photo-6-inf-cols row">
						...
						<div class="photo-6-inf-left col-lg-6">
								<img src="{{asset('Sprystore-Starter')}}/assets/images/1.jpg" class="img-fluid" alt="">
						</div>
					</div>
				 </div>
			 </div>
			...
			<div class="ecom-products-grids row mt-lg-5 mt-3">
				<div class="col-lg-3 col-6 product-incfhny mt-4">
					<div class="product-grid2 transmitv">
						<div class="product-image2">
							<a href="#">
								<img class="pic-1 img-fluid" src="{{asset('Sprystore-Starter')}}/assets/images/shop-1.jpg">
								<img class="pic-2 img-fluid" src="{{asset('Sprystore-Starter')}}/assets/images/shop-11.jpg">
							</a>
							<ul class="social">
				...
				<div class="col-lg-3 col-6 product-incfhny mt-4">
					<div class="product-grid2">
						<div class="product-image2">
							<a href="#">
								<img class="pic-1 img-fluid" src="{{asset('Sprystore-Starter')}}/assets/images/shop-2.jpg">
								<img class="pic-2 img-fluid" src="{{asset('Sprystore-Starter')}}/assets/images/shop-22.jpg">
							</a>
							<ul class="social">
									<li><a href="#" data-tip="Quick View"><span class="fa fa-eye"></span></a></li>
				...
				<div class="col-lg-3 col-6 product-incfhny mt-4">
					<div class="product-grid2">
						<div class="product-image2">
							<a href="#">
								<img class="pic-1 img-fluid" src="{{asset('Sprystore-Starter')}}/assets/images/shop-3.jpg">
								<img class="pic-2 img-fluid" src="{{asset('Sprystore-Starter')}}/assets/images/shop-33.jpg">
							</a>
							<ul class="social">
									<li><a href="#" data-tip="Quick View"><span class="fa fa-eye"></span></a></li>
				...
				<div class="col-lg-3 col-6 product-incfhny mt-4">
					<div class="product-grid2">
						<div class="product-image2">
							<a href="#">
								<img class="pic-1 img-fluid" src="{{asset('Sprystore-Starter')}}/assets/images/shop-4.jpg">
								<img class="pic-2 img-fluid" src="{{asset('Sprystore-Starter')}}/assets/images/shop-44.jpg">
							</a>
							<ul class="social">
									<li><a href="#" data-tip="Quick View"><span class="fa fa-eye"></span></a></li>
				...
				<div class="col-lg-3 col-6 product-incfhny mt-4">
					<div class="product-grid2">
						<div class="product-image2">
							<a href="#">
								<img class="pic-1 img-fluid" src="{{asset('Sprystore-Starter')}}/assets/images/shop-5.jpg">
								<img class="pic-2 img-fluid" src="{{asset('Sprystore-Starter')}}/assets/images/shop-55.jpg">
							</a>
							<ul class="social">
									<li><a href="#" data-tip="Quick View"><span class="fa fa-eye"></span></a></li>
				...
				<div class="col-lg-3 col-6 product-incfhny mt-4">
					<div class="product-grid2">
						<div class="product-image2">
							<a href="#">
								<img class="pic-1 img-fluid" src="{{asset('Sprystore-Starter')}}/assets/images/shop-6.jpg">
								<img class="pic-2 img-fluid" src="{{asset('Sprystore-Starter')}}/assets/images/shop-66.jpg">
							</a>
							<ul class="social">
									<li><a href="#" data-tip="Quick View"><span class="fa fa-eye"></span></a></li>
				...
				<div class="col-lg-3 col-6 product-incfhny mt-4">
					<div class="product-grid2">
						<div class="product-image2">
							<a href="#">
								<img class="pic-1 img-fluid" src="{{asset('Sprystore-Starter')}}/assets/images/shop-7.jpg">
								<img class="pic-2 img-fluid" src="{{asset('Sprystore-Starter')}}/assets/images/shop-77.jpg">
							</a>
							<ul class="social">
									<li><a href="#" data-tip="Quick View"><span class="fa fa-eye"></span></a></li>
				...
				<div class="col-lg-3 col-6 product-incfhny mt-4">
					<div class="product-grid2">
						<div class="product-image2">
							<a href="#">
								<img class="pic-1 img-fluid" src="{{asset('Sprystore-Starter')}}/assets/images/shop-8.jpg">
								<img class="pic-2 img-fluid" src="{{asset('Sprystore-Starter')}}/assets/images/shop-88.jpg">
							</a>
							<ul class="social">
									<li><a href="#" data-tip="Quick View"><span class="fa fa-eye"></span></a></li>
		...
		<div class="container py-lg-5">
			...
			<div class="post-hny-grids row mt-5">
				<div class="col-lg-3 col-md-6 grids5-info column-img" id="zoomIn">
					<a href="#">
						<figure>
							<img class="img-fluid" src="{{asset('Sprystore-Starter')}}/assets/images/bg1.jpg" alt="blog-image">
						</figure>
					</a>
				...
				<div class="col-lg-3 col-md-6 grids5-info column-img" id="zoomIn">
					<a href="#">
						<figure>
							<img class="img-fluid" src="{{asset('Sprystore-Starter')}}/assets/images/bg2.jpg" alt="blog-image">
						</figure>
					</a>
					<div class="blog-thumbhny-caption">
						<ul class="blog-info-list">
				...
				<div class="col-lg-3 col-md-6 grids5-info column-img" id="zoomIn">
					<figure>
						<img class="img-fluid" src="{{asset('Sprystore-Starter')}}/assets/images/bg3.jpg" alt="blog-image">
					</figure>
					<div class="blog-thumbhny-caption">
						<ul class="blog-info-list">
							<li><a href="#admin">By admin</a></li>
				...
				<div class="col-lg-3 col-md-6 grids5-info column-img" id="zoomIn">
					<figure>
						<img class="img-fluid" src="{{asset('Sprystore-Starter')}}/assets/images/bg4.jpg" alt="blog-image">
					</figure>
					<div class="blog-thumbhny-caption">
						<ul class="blog-info-list">
							<li><a href="#admin">By admin</a></li>
								...
								<div class="row">
									<div class="col-md-3">
										<div class="customer-info text-center">
											...
											<div class="feedback-review mt-4">
												<img src="{{asset('Sprystore-Starter')}}/assets/images/c1.jpg" class="img-fluid" alt="">
												<h5>Smith Roy</h5>
									...
									<div class="col-md-3">
											<div class="customer-info text-center">
													...
													<div class="feedback-review mt-4">
														<img src="{{asset('Sprystore-Starter')}}/assets/images/c2.jpg" class="img-fluid" alt="">
														<h5>Lora Grill</h5>
									...
									<div class="col-md-3">
											<div class="customer-info text-center">
													...
													<div class="feedback-review mt-4">
														<img src="{{asset('Sprystore-Starter')}}/assets/images/c3.jpg" class="img-fluid" alt="">
														<h5>Laura Sten</h5>
									...
									<div class="col-md-3">
											<div class="customer-info text-center">
													...
													<div class="feedback-review mt-4">
														<img src="{{asset('Sprystore-Starter')}}/assets/images/c4.jpg" class="img-fluid" alt="">
														<h5>John Lee</h5>
...
<script src="{{asset('Sprystore-Starter')}}/assets/js/jquery-3.3.1.min.js"></script>
<script src="{{asset('Sprystore-Starter')}}/assets/js/jquery-2.1.4.min.js"></script>
<!--/login-->
<script>
...
// optional
 ...
 <!-- cart-js -->
 <script src="{{asset('Sprystore-Starter')}}/assets/js/minicart.js"></script>
 <script>
     transmitv.render();
 ...
 <!-- //cart-js -->
<!--pop-up-box-->
<script src="{{asset('Sprystore-Starter')}}/assets/js/jquery.magnific-popup.js"></script>
<!--//pop-up-box-->
<script>
  $(document).ready(function () {
...
<!-- disable body scroll which navbar is in active -->
<script src="{{asset('Sprystore-Starter')}}/assets/js/bootstrap.min.js"></script>
